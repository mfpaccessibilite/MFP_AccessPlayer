...
module.exports = {
  ...
  plugins: [
    ...
    */
    ...
    new CopyWebpackPlugin([
      { from: Path.resolve(__dirname, '../src-demo/img'), to: './demo/img' }
    ]),
    new CopyWebpackPlugin([
      { from: Path.resolve(__dirname, '../src-demo/tracks'), to: './demo/tracks' }
    ]),
    new CopyWebpackPlugin([
      { from: Path.resolve(__dirname, '../src-demo/transcripts'), to: './demo/transcripts' }
    ]),
    new CopyWebpackPlugin([
      { from: Path.resolve(__dirname, '../src/js/lang'), to: './MFP/lang' }
    ]),
    new CopyWebpackPlugin([
      { from: Path.resolve(__dirname, '../src/infos'), to: './MFP/infos' }
    ]),
